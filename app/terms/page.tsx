...
export default function Terms() {
  return (
    <div className="w-full flex justify-center p-10 bg-white dark:bg-black">
      <div className="w-full max-w-screen-md space-y-6">
        <Link
          href="/"
          className="flex items-center gap-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 underline"
        >
          <ArrowLeftIcon className="w-4 h-4" />
          Back to Mobby
        </Link>
        <h1 className="text-3xl font-bold text-black dark:text-white">Mobby</h1>
        ...
        <p className="text-black dark:text-white font-semibold">
          Copyright © 2025 Osayi Eromhonsele. All Rights Reserved.
        </p>
      </div>
    </div>
  );
