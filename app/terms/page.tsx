      ...
      <div className="w-full max-w-screen-md space-y-6">
        ...
        <ol className="list-decimal list-inside space-y-4">
          ...
          <li className="text-gray-700">
            ...
            or implied. Osayi makes no representations or warranties regarding
          ...
          <li className="text-gray-700">
            ...
            the fullest extent permitted by applicable law, Osayi shall not be
            ...
            Osayi has been advised of the possibility of such damages.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">
          ...
          <li className="text-gray-700">
            ...
            decisions made based on its output. Osayi is not responsible for any
          ...
          <li className="text-gray-700">
            ...
            considered equivalent to public postings, and Osayi does not
          ...
          <li className="text-gray-700">
            ...
            indemnify, defend, and hold harmless Osayi from any claims,
            liabilities, damages, losses, and expenses, including reasonable
            legal fees, arising from your use of the Chatbot or violation of
            these Terms of Use.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">Modifications to Terms:</span> Osayi
          ...
          <li className="text-gray-700">
            ...
            contact Osayi at osayimichael@yahoo.com.
          </li>
        </ol>
      </div>
    </div>
